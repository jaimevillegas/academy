...
export function Navbar({ path }: { path?: string }) {
  ...
  return (
    <header className="w-full bg-[var(--chassis)]">
      <div className="flex h-[60px] items-center justify-between border-b border-[var(--grid)] px-[28px]">
        <Link href="/" className="flex items-center gap-[10px]">
          <span className="flex h-[26px] w-[26px] items-center justify-center font-mono-plex text-[14px] font-semibold bg-[var(--phosphor)] text-[var(--chassis)]">
            J
          </span>
          <span className="flex flex-col gap-px">
            ...
            <span className="font-mono-plex text-[9px] tracking-[0.6px] text-[var(--text-faint)]">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={
                  "flex h-full items-center border-b-2 px-[16px] font-mono-plex text-[11px] tracking-[0.8px] transition-instrument " +
                  state
                }
              >
                [{item.label}]
        ...
        <div className="flex items-center gap-[8px]">
          <Link
            href="/soporte"
            className="group flex items-center gap-[7px] border border-[var(--grid)] px-[14px] py-[8px] transition-instrument hover:border-[var(--text)] hover:bg-[var(--text)]"
          >
            <LifeBuoy
              size={13}
              strokeWidth={1.5}
      ...
      <div className="flex h-[28px] items-center justify-between border-b border-[var(--grid)] bg-[var(--panel)] px-[28px]">
        <div className="flex items-center gap-[20px]">
          <span className="flex items-center gap-[7px]">
            <span className="h-[6px] w-[6px] rounded-full bg-[var(--phosphor)]" />
